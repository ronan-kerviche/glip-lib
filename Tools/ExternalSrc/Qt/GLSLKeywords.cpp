...
using namespace GLSLLanguage;

	const char* GLSLLanguage::GLSLKeywords[] =
	{
		"attribute\0",
		"const\0",
		"uniform\0",
	...
	const char* GLSLLanguage::GLSLFunctions[] = 
	{
		"abs\0",
		"acos\0",
		"acosh\0",
	...
	const char* GLSLLanguage::GLSLPreprocessor[] = 
	{
		"#define\0",
		"#undef\0",
		"#if\0",
