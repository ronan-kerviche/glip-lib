...
// Structure
	// Data
		...
		#else
		const GLenum			HandleOpenGL::shaderTypes[GLIP_NUM_SHADER_TYPES] = {GL_VERTEX_SHADER, GL_FRAGMENT_SHADER, GL_COMPUTE_SHADER};
		#endif
...
// Errors Monitoring
	...
	**/
	std::string Glip::CoreGL::getGLErrorDescription(const GLenum& e)
	{
		...
		switch(e)
		{
			...
			#endif
			MAP( GL_INVALID_FRAMEBUFFER_OPERATION,			"Invalid framebuffer operation (possible incomplete texture).")
	...
	**/
	...
	const HandleOpenGL::KeywordPair HandleOpenGL::glKeywords[] =
	{
		...
		#endif
		KEYWORD_PAIR( GL_INVALID_FRAMEBUFFER_OPERATION )
		...
		KEYWORD_PAIR( GL_ARRAY_BUFFER )
		KEYWORD_PAIR( GL_ELEMENT_ARRAY_BUFFER )
		KEYWORD_PAIR( GL_READ_ONLY )
		KEYWORD_PAIR( GL_WRITE_ONLY )
		KEYWORD_PAIR( GL_READ_WRITE )

		KEYWORD_PAIR( GL_STATIC_DRAW )
		KEYWORD_PAIR( GL_STATIC_READ )
		KEYWORD_PAIR( GL_STATIC_COPY )
		KEYWORD_PAIR( GL_DYNAMIC_DRAW )
		KEYWORD_PAIR( GL_DYNAMIC_READ )
		KEYWORD_PAIR( GL_DYNAMIC_COPY )
		KEYWORD_PAIR( GL_STREAM_DRAW )
		KEYWORD_PAIR( GL_STREAM_READ )
		KEYWORD_PAIR( GL_STREAM_COPY )
