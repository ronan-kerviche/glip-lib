...
{GL_R8,	GL_RED,	GL_R8,	GL_COMPRESSED_RED, 1, {GL_RED, GL_NONE, GL_NONE, GL_NONE}, {8, 0, 0, 0}, {GL_UNSIGNED_BYTE, GL_NONE, GL_NONE, GL_NONE}, false, false, true},
...
{GL_R16, GL_RED, GL_R16, GL_COMPRESSED_RED, 1, {GL_RED, GL_NONE, GL_NONE, GL_NONE}, {16, 0, 0, 0}, {GL_UNSIGNED_SHORT, GL_NONE, GL_NONE, GL_NONE}, false, false, true},
...
{GL_ALPHA8, GL_ALPHA, GL_ALPHA8, GL_COMPRESSED_ALPHA, 1, {GL_ALPHA, GL_NONE, GL_NONE, GL_NONE}, {8, 0, 0, 0}, {GL_UNSIGNED_BYTE, GL_NONE, GL_NONE, GL_NONE}, false, false, true},
...
{GL_ALPHA16, GL_ALPHA, GL_ALPHA16, GL_COMPRESSED_ALPHA, 1, {GL_ALPHA, GL_NONE, GL_NONE, GL_NONE}, {16, 0, 0, 0}, {GL_UNSIGNED_SHORT, GL_NONE, GL_NONE, GL_NONE}, false, false, true},
...
{GL_LUMINANCE8, GL_LUMINANCE, GL_LUMINANCE8, GL_COMPRESSED_LUMINANCE, 1, {GL_LUMINANCE, GL_NONE, GL_NONE, GL_NONE}, {8, 0, 0, 0}, {GL_UNSIGNED_BYTE, GL_NONE, GL_NONE, GL_NONE}, false, false, true},
...
{GL_LUMINANCE16, GL_LUMINANCE, GL_LUMINANCE16, GL_COMPRESSED_LUMINANCE, 1, {GL_LUMINANCE, GL_NONE, GL_NONE, GL_NONE}, {16, 0, 0, 0}, {GL_UNSIGNED_SHORT, GL_NONE, GL_NONE, GL_NONE}, false, false, true},
...
{GL_INTENSITY8, GL_INTENSITY, GL_INTENSITY8, GL_COMPRESSED_INTENSITY, 1, {GL_INTENSITY, GL_NONE, GL_NONE, GL_NONE}, {8, 0, 0, 0}, {GL_UNSIGNED_BYTE, GL_NONE, GL_NONE, GL_NONE}, false, false, true},
...
{GL_INTENSITY16, GL_INTENSITY, GL_INTENSITY16, GL_COMPRESSED_INTENSITY, 1, {GL_INTENSITY, GL_NONE, GL_NONE, GL_NONE}, {16, 0, 0, 0}, {GL_UNSIGNED_SHORT, GL_NONE, GL_NONE, GL_NONE}, false, false, true},
...
{GL_RG8, GL_RG, GL_RG8, GL_COMPRESSED_RG, 2, {GL_RED, GL_GREEN, GL_NONE, GL_NONE}, {8, 8, 0, 0}, {GL_UNSIGNED_BYTE, GL_UNSIGNED_BYTE, GL_NONE, GL_NONE}, false, false, true},
...
{GL_RG16, GL_RG, GL_RG16, GL_COMPRESSED_RG, 2, {GL_RED, GL_GREEN, GL_NONE, GL_NONE}, {16, 16, 0, 0}, {GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT, GL_NONE, GL_NONE}, false, false, true},
...
{GL_RGB8, GL_RGB, GL_RGB8, GL_COMPRESSED_RGB, 3, {GL_RED, GL_GREEN, GL_BLUE, GL_NONE}, {8, 8, 8, 0}, {GL_UNSIGNED_BYTE, GL_UNSIGNED_BYTE, GL_UNSIGNED_BYTE, GL_NONE}, false, false, true},
...
{GL_SRGB8, GL_RGB, GL_SRGB8, GL_COMPRESSED_SRGB, 3, {GL_RED, GL_GREEN, GL_BLUE, GL_NONE}, {8, 8, 8, 0}, {GL_UNSIGNED_BYTE, GL_UNSIGNED_BYTE, GL_UNSIGNED_BYTE, GL_NONE}, false, false, true},
...
{GL_RGB16, GL_RGB, GL_RGB16, GL_COMPRESSED_RGB, 3, {GL_RED, GL_GREEN, GL_BLUE, GL_NONE}, {16, 16, 16, 0}, {GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT, GL_NONE}, false, false, true},
...
{GL_RGBA8, GL_RGBA, GL_RGBA8, GL_COMPRESSED_RGBA, 4, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}, {8, 8, 8, 8}, {GL_UNSIGNED_BYTE, GL_UNSIGNED_BYTE, GL_UNSIGNED_BYTE, GL_UNSIGNED_BYTE}, false, false, true},
...
{GL_RGBA16, GL_RGBA, GL_RGBA16, GL_COMPRESSED_RGBA, 4, {GL_RED, GL_GREEN, GL_BLUE, GL_ALPHA}, {16, 16, 16, 16}, {GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT, GL_UNSIGNED_SHORT}, false, false, true},
