	...
	**/
	bool HdlTextureFormatDescriptor::hasChannel(GLenum channel) const
	{
		switch(channel)
		{
			...
			default :
				throw Exception("HdlTextureFormatDescriptor::hasChannel - Unknown channel name : \"" + getGLEnumNameSafe(channel) + "\".", __FILE__, __LINE__, Exception::GLException);
		}
	}
	...
	**/
	unsigned int HdlTextureFormatDescriptor::channelSizeInBits(GLenum channel) const
	{
		switch(channel)
		{
			...
			default :
				throw Exception("HdlTextureFormatDescriptor::channelSizeInBits - Unknown channel name : \"" + getGLEnumNameSafe(channel) + "\".", __FILE__, __LINE__, Exception::GLException);
		}
	}
	...
	**/
	GLenum HdlTextureFormatDescriptor::channelType(GLenum channel) const
	{
		switch(channel)
		{
			...
			default :
				throw Exception("HdlTextureFormatDescriptor::channelType - Unknown channel name : \"" + getGLEnumNameSafe(channel) + "\".", __FILE__, __LINE__, Exception::GLException);
		}
	}
	...
	**/
	int HdlTextureFormatDescriptor::channelIndex(GLenum channel) const
	{
		switch(channel)
		{
			...
			default :
				throw Exception("HdlTextureFormatDescriptor::channelIndex - Unknown channel name : \"" + getGLEnumNameSafe(channel) + "\".", __FILE__, __LINE__, Exception::GLException);
		}
	}
...
// HdlTextureFormatDescriptorList :
	...
	**/
	const HdlTextureFormatDescriptor& HdlTextureFormatDescriptorsList::get(const GLenum& modeID)
	{
		...
		//else
			throw Exception("HdlTextureFormatDescriptorsList::get - No corresponding mode for : " + getGLEnumNameSafe(modeID) + ".", __FILE__, __LINE__, Exception::GLException);
	}
	...
	**/
	int HdlTextureFormatDescriptorsList::getTypeDepth(GLenum depth)
	{
		switch(depth)
		{
			...
			default :
				//colSize = 0;
				throw Exception("HdlTextureFormatDescriptorsList::getTypeDepth - cannot recognize color channel type " + getGLEnumNameSafe(depth), __FILE__, __LINE__, Exception::GLException);
		}
	}
