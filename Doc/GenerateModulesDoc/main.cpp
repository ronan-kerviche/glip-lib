/*
	GLIP-LIB
	Generate HTML documentation for the standard modules, writes to stdout. 

	Compile to the simplest :
	g++ -o gen main.cpp -I../../GLIP-Lib/include -L../../GLIP-Lib/lib -lGL -lglip
*/
#include <GLIPLib.hpp>

std::string generateModuleDoc(Glip::Modules::LayoutLoaderModule& m)
{
	std::string str;
