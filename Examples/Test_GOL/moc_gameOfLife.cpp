/****************************************************************************
** Meta object code from reading C++ file 'gameOfLife.hpp'
**
** Created: Sat Dec 10 00:06:45 2011
...
#error "The header file 'gameOfLife.hpp' doesn't include <QObject>."
...
static const char qt_meta_stringdata_GameOfLife[] = {
    "GameOfLife\0\0compute()\0"
};

const QMetaObject GameOfLife::staticMetaObject = {
    { &QApplication::staticMetaObject, qt_meta_stringdata_GameOfLife,
      qt_meta_data_GameOfLife, 0 }
};
